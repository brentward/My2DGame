...
public class Entity {
    ...
    public void checkAttack(int rate, int rangeLength, int rangeWidth) {
        ...
        switch (direction) {
            case UP -> {
                if (gp.player.getCenterY() < getCenterY() && yDistance < rangeLength && xDistance < rangeWidth) {
                    targetInRange = true;
                }
            }
            case DOWN -> {
            ...
            case LEFT -> {
                if (gp.player.getCenterX() < getCenterX() && xDistance < rangeLength && yDistance < rangeWidth) {
                    targetInRange = true;
                }
            }
            case RIGHT -> {
        ...
        if (spriteCounter > attackWindupDuration && spriteCounter <= attackDuration) {
            ...
            switch (direction) {
                case UP -> {
                    ...
                    worldX += (solidArea.width - attackArea.width) / 2;
                }
                case DOWN -> {
                ...
                case LEFT -> {
                    ...
                    worldY += (solidArea.height - attackArea.height) / 2;
                }
                case RIGHT -> {
